...
(function() {
  $(function() {
    return $('.add-credit').click(function() {
      return alert('NOT IMPLEMENTED! ONE SHOULD ADD CREDIT THROUGH ADMIN ZONE!');
    });
  });

}).call(this);
(function() {
  this.initBets = function() {
    var updateBetWin;
    updateBetWin = function(gameLine, team) {
      var $addButton, attrs, bet, odds, risk, totalPayout, win;
      ...
      if (risk > 0) {
        return $addButton.show();
      } else {
        return $addButton.hide();
      }
    };
    $('.bet-risk').change(function() {
      return updateBetWin($(this).data('game-line'), $(this).data('team'));
    });
    $('.bet-risk').keyup(function() {
      return updateBetWin($(this).data('game-line'), $(this).data('team'));
    });
    return $('.bet-risk').each(function() {
      return updateBetWin($(this).data('game-line'), $(this).data('team'));
    });
  };

  this.hideBetForm = function(gameLine, team) {
    var attrs;
    attrs = '[data-game-line="' + gameLine + '"][data-team="' + team + '"]';
  ...
  $(function() {
    initBets();
    $('.link_to_add_bet').click(function(e) {
      var betDiv, gameLine, team;
    ...
    return $('.add-bet .event-remove').click(function(e) {
      var gameLine, team;
