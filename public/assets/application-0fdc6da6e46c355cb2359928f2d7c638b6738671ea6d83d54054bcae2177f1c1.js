...
(function() {
  this.initBets = function() {
    var updateBetWin;
    updateBetWin = function(id) {
      var $updateButton, bet, odds, risk, totalPayout, win;
      ...
      if (parseFloat($updateButton.data('risk')) !== risk) {
        return $updateButton.show();
      } else {
        return $updateButton.hide();
      }
    };
    $('.bet-risk').change(function() {
      return updateBetWin($(this).data('bet'));
    });
